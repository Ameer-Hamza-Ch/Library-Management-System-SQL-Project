...
add constraint fk_issuedmem_id foreign key(issued_member_id) references members(member_id);

alter table employee
add constraint fk_branch_id foreign key(branch_id) references branch(branch_id); 

alter table issued_status
add constraint fk_isbn foreign key(issued_book_isbn) references books(isbn);
